...
function Mission() {
    return(
        <div className="h-full min-h-screen w-full bg-gray-900 pt-12 p-8 ">
            <div className='text-center mx-auto my-10 mb-14'>
            <h1 className="text-4xl font-extrabold tracking-tight text-white sm:text-5xl md:text-4xl lg:text-5xl xl:text-6xl">
                  <span className="block xl:inline">Our Core Values </span>
                  <span className="block text-orange-600 xl:inline text-5xl mt-2">Trusted In Our Client.</span>
                </h1>
                <p className="mx-auto mt-10 text-base text-gray-500 sm:max-w-md lg:text-xl md:max-w-3xl">
                  It's never been easier to build beautiful websites that convey your message and tell your story.
                </p>
            </div>
            <div className="grid gap-18 md:grid-cols-2 md:gap-10 lg:grid-cols-3 lg:gap-10 sm:gap-10 px-5 ">
                <div className="rounded-xl bg-white shadow-xl text-center  p-8 border-2 border-transparent transition-all duration-300 ease-in-out transform hover:scale-105 hover:border-green-500">
                <div
                ...
                <h1 className="text-orange-600 mb-3 text-xl font-medium lg:px-14">Innovation & Creativity  </h1>
                <p className="px-4 text-gray-500">We take pride in our work and strive to deliver the best results</p>
                </div>

                <div data-aos-delay="150" className="rounded-xl bg-white shadow-xl text-center border-gray-200 p-8 border-2 border-transparent transition-all duration-300 ease-in-out transform hover:scale-105 hover:border-green-500">
                <div
                ...
                <h1 className="text-orange-600 mb-3 text-xl font-medium lg:px-14 ">Integrity & Transparency</h1>
                <p className="px-4 text-gray-500">We take pride in our work and strive to deliver the best results</p>
                </div>
                <div data-aos-delay="300" className="rounded-xl bg-white text-center p-8 border-2 border-transparent transition-all duration-300 ease-in-out transform hover:scale-105 hover:border-green-500">
                <div
                ...
                <h1 className="text-orange-600 mb-3 pt-3 text-xl font-medium lg:h-14 lg:px-14">Customer-Centric Approach </h1>
                <p className="px-4 text-gray-500">We take pride in our work and strive to deliver the best results</p>
                </div>
                
                <div data-aos-delay="300" className="rounded-xl bg-white shadow-xl text-center p-8 border-2 border-transparent transition-all duration-300 ease-in-out transform hover:scale-105 hover:border-green-500">
                <div
                    className="mx-auto flex h-16 w-16 -translate-y-12 transform items-center justify-center rounded-full shadow-lg bg-sky-500 shadow-sky-500/40">
                    <svg viewBox="0 0 55 44" fill="none" xmlns="http://www.w3.org/2000/svg" className="h-6 w-6 text-white">
                    <path
                ...
                <h1 className="text-orange-600 mb-3 pt-3 text-xl font-medium lg:h-14 lg:px-14">Growth & Learning</h1>
                <p className="px-4 text-gray-500">We foster an environment of continuous improvement and development.
                </p>
                </div>
                <div data-aos-delay="300" className="rounded-xl bg-white shadow-xl text-center p-8 border-2 border-transparent transition-all duration-300 ease-in-out transform hover:scale-105 hover:border-green-500">
                <div
                ...
                <h1 className="text-orange-600 mb-3 pt-3 text-xl font-medium lg:h-14 lg:px-14">Passion & Excellence  </h1>
                <p className="px-4 text-gray-500">We take pride in our work and strive to deliver the best results.</p>
                </div>
                <div data-aos-delay="300" className="rounded-xl bg-white shadow-xl text-center p-8 border-2 border-transparent transition-all duration-300 ease-in-out transform hover:scale-105 hover:border-green-500">
                <div
                ...
                <h1 className="text-orange-600 mb-3 pt-3 text-xl font-medium lg:h-14 lg:px-14">Collaboration & Teamwork  </h1>
                <p className="px-4 text-gray-500">Success is achieved when we work together and uplift one another.</p>
                </div>
            </div>
           </div>
    )
